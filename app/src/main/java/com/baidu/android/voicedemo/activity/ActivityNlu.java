...
public class ActivityNlu extends ActivityRecog {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            XTelephoneRecognization.require(this.getResources().getAssets().open("names.txt"));
            XDateTimeRecognization.require(this.getResources().getAssets().open("datetime.txt"));
            XAppRecognization.require(this.getResources().getAssets().open("app.txt"));
        } catch (IOException e) {
            e.printStackTrace();
